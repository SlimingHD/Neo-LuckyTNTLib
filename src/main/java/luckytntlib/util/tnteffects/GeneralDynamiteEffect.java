...
public class GeneralDynamiteEffect extends PrimedTNTEffect{
	...
	private final Supplier<DeferredItem<LDynamiteItem>> dynamite;
	 ...
	 */
	public GeneralDynamiteEffect(Supplier<DeferredItem<LDynamiteItem>> dynamite, ParticleOptions particles, PrimedTNTEffect effect) {
	 ...
	 * @param effect  TNT effect to execute
	 */
	public GeneralDynamiteEffect(Supplier<DeferredItem<LDynamiteItem>> dynamite, PrimedTNTEffect effect) {
		this.dynamite = dynamite;
		this.effect = effect;
	}
