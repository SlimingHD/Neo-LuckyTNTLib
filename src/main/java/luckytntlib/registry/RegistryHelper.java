...
public class RegistryHelper {
	 ...
	 * @return {@link DeferredBlock} of a {@link LTNTBlock}
	 */
	 ...
	 * @return {@link DeferredBlock} of a {@link LTNTBlock}
	 */
	public DeferredBlock<LTNTBlock> registerTNTBlock(DeferredRegister.Blocks blockRegistry, @Nullable DeferredRegister.Items itemRegistry, Supplier<LTNTBlock> TNTBlock, TNTBlockRegistryData blockData){
		DeferredBlock<LTNTBlock> block = blockRegistry.register(blockData.getRegistryName(), TNTBlock);
		if(itemRegistry != null && blockData.makeItem()) {
			DeferredItem<Item> item = itemRegistry.register(blockData.getRegistryName(), () -> new BlockItem(block.get(), new Item.Properties()) {
			...
			if(blockData.addToTNTLists()) {
				if(TNTLists.get(blockData.getTab()) == null) {
					TNTLists.put(blockData.getTab(), new ArrayList<DeferredBlock<LTNTBlock>>());
				}
				TNTLists.get(blockData.getTab()).add(block);
			}
			if(blockData.addDispenseBehavior()) {
				TNT_DISPENSER_REGISTRY_LIST.add(new Pair<DeferredBlock<LTNTBlock>, DeferredItem<Item>>(block, item));
			}
			if(!blockData.getTab().equals("none")) {
				if(creativeTabItemLists.get(blockData.getTab()) == null) {
					creativeTabItemLists.put(blockData.getTab(), new ArrayList<DeferredItem<? extends Item>>());
				}
	 ...
	 * @return {@link DeferredBlock} of a {@link LTNTBlock}
	 */
	public DeferredBlock<LTNTBlock> registerLivingTNTBlock(DeferredRegister.Blocks blockRegistry, @Nullable DeferredRegister.Items itemRegistry, Supplier<LivingLTNTBlock> TNTBlock, TNTBlockRegistryData blockData){
		DeferredBlock<LTNTBlock> block = blockRegistry.register(blockData.getRegistryName(), () -> ((LTNTBlock)TNTBlock.get()));
		if(itemRegistry != null && blockData.makeItem()) {
			DeferredItem<Item> item = itemRegistry.register(blockData.getRegistryName(), () -> new BlockItem(block.get(), new Item.Properties()) {
	 ...
	 * @return {@link DeferredItem} of a {@link LDynamiteItem}
	 */
	public DeferredItem<LDynamiteItem> registerDynamiteItem(String registryName, Supplier<LDynamiteItem> dynamiteSupplier, String tab){
	 ...
	 * @return {@link DeferredItem} of a {@link LDynamiteItem}
	 */
	public DeferredItem<LDynamiteItem> registerDynamiteItem(String registryName, Supplier<LDynamiteItem> dynamiteSupplier, String tab, boolean addToLists, boolean addDispenseBehavior){
	 ...
	 * @return {@link DeferredItem} of a {@link LDynamiteItem}
	 */
	public DeferredItem<LDynamiteItem> registerDynamiteItem(DeferredRegister.Items itemRegistry, String registryName, Supplier<LDynamiteItem> dynamiteSupplier, String tab, boolean addToLists, boolean addDispenseBehavior){
		DeferredItem<LDynamiteItem> item = itemRegistry.register(registryName, dynamiteSupplier);		
		if(addToLists) {
			if(dynamiteLists.get(tab) == null) {
				dynamiteLists.put(tab, new ArrayList<DeferredItem<LDynamiteItem>>());
			}
		...
		if(!tab.equals("none")) {
			if(creativeTabItemLists.get(tab) == null) {
				creativeTabItemLists.put(tab, new ArrayList<DeferredItem<? extends Item>>());
			}
	 ...
	 * @return {@link DeferredItem} of a {@link LTNTMinecartItem}
	 */
	 ...
	 * @return {@link DeferredItem} of a {@link LTNTMinecartItem}
	 */
	public DeferredItem<LTNTMinecartItem> registerTNTMinecartItem(String registryName, Supplier<LTNTMinecartItem> minecartSupplier, String tab, boolean addToLists, boolean addDispenseBehavior){
	 ...
	 * @return {@link DeferredItem} of a {@link LTNTMinecartItem}
	 */
	public DeferredItem<LTNTMinecartItem> registerTNTMinecartItem(DeferredRegister.Items itemRegistry, String registryName, Supplier<LTNTMinecartItem> minecartSupplier, String tab, boolean addToLists, boolean addDispenseBehavior){
		DeferredItem<LTNTMinecartItem> item = itemRegistry.register(registryName, minecartSupplier);
		if(addToLists) {
			if(minecartLists.get(tab) == null) {
				minecartLists.put(tab, new ArrayList<DeferredItem<LTNTMinecartItem>>());
			}
